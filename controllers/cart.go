...
import (
	...
	"github.com/sankalpneel/ecommerce/database"
	"github.com/sankalpneel/ecommerce/models"
...
func (app *Application) AddToCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		productID, err := primitive.ObjectIDFromHex(produtQueryID)
...
func (app *Application) RemoveItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			log.Println(err)
			c.AbortWithError(http.StatusInternalServerError, errors.New("Somethong went wrong"))
			return
		}
		var ctx, cancel = context.WithTimeout(context.Background(), 5*time.Second)
		defer cancel()
